    ...
    data.forEach((todoObj) => {
        document.querySelectorAll("[data-up]").forEach((up) => {
            up.addEventListener("click", () => {
                up.parentElement.innerHTML = `
                    <input type = "text data-input value = "">
                    <button data-end class ="end"></button>
                    <button data-rm>Delete</button>
                `;
                document.querySelectorAll(["data-end"]).forEach(end => {
                    end.addEventListener("click", () => {
                        end.parentElement.innerHTML = `
                            <div>
                                <p>
                                    ${end.previousElementSibling.value}
                                </p>
                                <button data-up>UPDATE</button>
                                <button data-rm>Delete</button>
                            </div>
                        `;
                    });
